...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_pages_blocks_cta_links_link_appearance" CASCADE;
  ...
  DROP TYPE "public"."enum_pages_blocks_content_columns_link_appearance" CASCADE;
  ...
  DROP TYPE "public"."enum__pages_v_version_hero_links_link_appearance" CASCADE;
  ...
  DROP TYPE "public"."enum__pages_v_blocks_cta_links_link_appearance" CASCADE;
  ...
  DROP TYPE "public"."enum__pages_v_blocks_content_columns_link_appearance" CASCADE;
