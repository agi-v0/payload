...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "pages_rels" DROP CONSTRAINT "pages_rels_logos_fk";
  
  ALTER TABLE "_pages_v_rels" DROP CONSTRAINT "_pages_v_rels_logos_fk";
  
  ALTER TABLE "payload_locked_documents_rels" DROP CONSTRAINT "payload_locked_documents_rels_logos_fk";
  
  DROP INDEX IF EXISTS "pages_rels_logos_id_idx";
  DROP INDEX IF EXISTS "_pages_v_rels_logos_id_idx";
  DROP INDEX IF EXISTS "payload_locked_documents_rels_logos_id_idx";
  ALTER TABLE "pages_rels" DROP COLUMN IF EXISTS "logos_id";
  ALTER TABLE "_pages_v_rels" DROP COLUMN IF EXISTS "logos_id";
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  ALTER TABLE "pages_rels" ADD COLUMN "logos_id" integer;
  ALTER TABLE "_pages_v_rels" ADD COLUMN "logos_id" integer;
