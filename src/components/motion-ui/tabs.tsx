...
import {
  MotionHighlight,
  MotionHighlightItem,
} from '@/components/motion-ui/effects/motion-highlight'
...
function TabsList({
  ...
  return (
    <MotionHighlight
      controlledItems
      className={cn(
        'bg-background-neutral border-input -shadow-sm rounded-[10px] border',
        activeClassName,
      )}
      value={activeValue}
      transition={transition}
  ...
  return (
    <MotionHighlightItem value={value} className="size-full">
      <motion.button
        ...
        className={cn(
          'ring-offset-background focus-visible:ring-ring data-[state=active]:text-foreground z-[1] inline-flex size-full cursor-pointer items-center justify-center rounded-[10px] px-4 py-2 text-base font-medium whitespace-nowrap transition-transform focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50',
