...
export const Variant04: React.FC<VariantProps> = ({ columns, showBadge, badgeConfig }) => {
  // This variant typically displays one main feature column
  const column = columns[0] || { title: '', content: null }
        ...
        {showBadge && column.showBadge && column.badgeConfig?.badge?.label && (
          <Badge
            className={`inline-flex items-center ${
              column.badgeConfig.badge.icon_dir || 'flex-row'
            } gap-1.5`}
          >
